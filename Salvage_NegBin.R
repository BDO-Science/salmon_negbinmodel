...
Mod.NegBin2 <- glm.nb(Salvage.Total~Total.exports.z, data=Winter.salv)
Mod.NegBin3 <- glm.nb(Salvage.Total~OMR.z, data=Winter.salv)
Mod.NegBin4 <- glm.nb(Salvage.Total~Total.exports.z+OMR.z, data=Winter.salv)
Mod.NegBin5 <- glm.nb(Salvage.Total~Total.exports.z*OMR.z, data=Winter.salv)
Mod.NegBin6 <- glm.nb(Salvage.Total~Discharge.z, data=Winter.salv)
Mod.NegBin7 <- glm.nb(Salvage.Total~Discharge.z+Total.exports.z, data=Winter.salv)
Mod.NegBin8 <- glm.nb(Salvage.Total~Discharge.z+OMR.z, data=Winter.salv)
Mod.NegBin9 <- glm.nb(Salvage.Total~Discharge.z+OMR.z+Total.exports.z, data=Winter.salv)
#Mod.NegBin10 <- glm.nb(Salvage.Total~Discharge.z*OMR.z+Total.exports.z, data=Winter.salv)
Mod.NegBin11 <- glm.nb(Salvage.Total~Discharge.z*Total.exports.z+OMR.z, data=Winter.salv)
Mod.NegBin12 <- glm.nb(Salvage.Total~Discharge.z*Total.exports.z*OMR.z, data=Winter.salv)
Mod.NegBin13 <- glm.nb(Salvage.Total~Discharge.z+Month, data=Winter.salv)
Mod.NegBin14 <- glm.nb(Salvage.Total~Discharge.z*Month, data=Winter.salv)
Mod.NegBin15 <- glm.nb(Salvage.Total~Discharge.z + OMR.z + Month, data=Winter.salv)
Mod.NegBin16 <- glm.nb(Salvage.Total~Discharge.z + Total.exports.z + Month, data=Winter.salv)
Mod.NegBin17 <- glm.nb(Salvage.Total~Discharge.z + OMR.z + Total.exports.z + Month, data=Winter.salv)
Mod.NegBin18 <- glm.nb(Salvage.Total~Discharge.z + OMR.z*Total.exports.z + Month, data=Winter.salv)
Mod.NegBin19 <- glm.nb(Salvage.Total~OMR.z*Total.exports.z + Month, data=Winter.salv)
Mod.NegBin20 <- glm.nb(Salvage.Total~OMR.z + Total.exports.z + Month, data=Winter.salv)
Mod.NegBin21 <- glm.nb(Salvage.Total~OMR.z + Total.exports.z*Month, data=Winter.salv)
Mod.NegBin22 <- glm.nb(Salvage.Total~OMR.z*Month + Total.exports.z, data=Winter.salv)

### including escapement ###
Mod.NegBin23 <- glm.nb(Salvage.Total~Escape.z, data=Winter.salv)
Mod.NegBin24 <- glm.nb(Salvage.Total~Escape.z+Month, data=Winter.salv)
Mod.NegBin25 <- glm.nb(Salvage.Total~Escape.z+Month+Discharge.z, data=Winter.salv)
Mod.NegBin26 <- glm.nb(Salvage.Total~Escape.z+Month+Discharge.z+Total.exports.z, data=Winter.salv)
Mod.NegBin27 <- glm.nb(Salvage.Total~Escape.z+Month+Discharge.z+Total.exports.z+OMR.z, data=Winter.salv)
Mod.NegBin28 <- glm.nb(Salvage.Total~Escape.z+Month+Discharge.z+OMR.z, data=Winter.salv)
Mod.NegBin29 <- glm.nb(Salvage.Total~Escape.z+Month+Total.exports.z+OMR.z, data=Winter.salv)
Mod.NegBin30 <- glm.nb(Salvage.Total~Escape.z+Month+Total.exports.z, data=Winter.salv)
Mod.NegBin31 <- glm.nb(Salvage.Total~Escape.z+Month+OMR.z, data=Winter.salv)
Mod.NegBin32 <- glm.nb(Salvage.Total~Escape.z+Month*Total.exports.z+OMR.z, data=Winter.salv)
Mod.NegBin33 <- glm.nb(Salvage.Total~Escape.z+Month*OMR.z+Total.exports.z, data=Winter.salv)
Mod.NegBin34 <- glm.nb(Salvage.Total~Escape.z+Month*Total.exports.z, data=Winter.salv)
Mod.NegBin35 <- glm.nb(Salvage.Total~Escape.z+Month*OMR.z, data=Winter.salv)
#Mod.NegBin36 <- glm.nb(Salvage.Total~Escape.z*OMR.z+Month+Total.exports.z, data=Winter.salv)
#Mod.NegBin37 <- glm.nb(Salvage.Total~Escape.z*Total.exports.z+OMR.z+Month, data=Winter.salv)
#Mod.NegBin38 <- glm.nb(Salvage.Total~OMR.z*Month*Total.exports.z, data=Winter.salv)



AICc(Mod.NegBin0, Mod.NegBin1, Mod.NegBin2, Mod.NegBin3, Mod.NegBin4, Mod.NegBin5, Mod.NegBin6, Mod.NegBin7, Mod.NegBin8, Mod.NegBin9, Mod.NegBin11, Mod.NegBin12, Mod.NegBin13, Mod.NegBin14, Mod.NegBin15, Mod.NegBin16, Mod.NegBin17, Mod.NegBin18, Mod.NegBin19, Mod.NegBin20, Mod.NegBin21, Mod.NegBin22, Mod.NegBin23, Mod.NegBin24, Mod.NegBin25, Mod.NegBin26, Mod.NegBin27, Mod.NegBin28, Mod.NegBin29, Mod.NegBin30, Mod.NegBin31, Mod.NegBin32, Mod.NegBin33, Mod.NegBin34, Mod.NegBin35)

summary(Mod.NegBin22)
...
est <- cbind(Estimate = coef(Mod.NegBin22), confint(Mod.NegBin22))
exp(est)
...
Winter.salv$resid <- resid(Mod.NegBin22)
...
for(i in 1:nrow(Winter.salv)){
  ...
  Temp.mod1 <- glm.nb(Salvage.Total~OMR.z*Month + Total.exports.z, data=Hat.dat)
...
pred.goods <- predict(Mod.NegBin22, newdata = pred.dat, type="link", se.fit=TRUE)
...
jpeg(filename = "Salvage_Model_HighExports.jpg", heigh=5, width = 6, units="in", bg="white", res=500)
